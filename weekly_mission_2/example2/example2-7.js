...
class MissionCommander {
  ...
  console.log("Actualizado los atributos de la clase")
  console.log(`Students: ${missionCommanderNode.getStudents}`) // 100 Students
  console.log(`Lives: ${missionCommanderNode.getLives}`)// 3 Lives